...
Stable IDs (`BL-NNN`) are never renumbered. Phase tags follow `init.md` (P0–P14). Status is `open`, `in-progress`, or `closed`.
...
| BL-006 | Sessions, agent threads, delegation jobs, and job queue | P4 | init.md Phase 4 | open |
| BL-007 | Staging, review, security review, promotion, rollback, and controlled restart flow | P5 | init.md Phase 5 | open |
| BL-008 | YAML skill platform with skill index, permissions, and telemetry | P6 | init.md Phase 6 | open |
| BL-009 | Real Obsidian Vault integration, inbox triage, and structured wiki | P9 | init.md Phase 9; ADR 0002 | open |
| BL-010 | Richer Mastra telemetry and tracing beyond basic JSONL Run logs | P1+ | PRD Out of Scope | open |
